  ...
  return (
    <div className='flex items-center w-full h-[80px] py-4 md:px-8 sm:px-4 px-1'>
      <div className='relative h-[40px] w-[40px] sm:w-[50px] sm:h-[50px] cursor-pointer lg:ml-[23px] '>
        <Image objectFit='cover' src={Logo} alt='logo' layout='fill' />
      </div>
      <div className='ml-20 bg-searchBg rounded-md h-[40px] sm:flex items-center px-2 overflow-hidden text-gray-400 outline outline-gray-900 hidden'>
        <Search />
        <input
      ...
      <div className='flex items-center justify-evenly h-[40px] lg:w-[25%] ml-auto'>
        ...
        <div className='flex items-center'>
          <div className='relative h-[40px] w-[40px] min-w-[40px] rounded-full cursor-pointer'>
            <Image src={ProfilePic} objectFit='cover' alt='profilePic' />
          </div>

          <p className='text-gray-400 text-[12px] font-bold ml-2'>
            Gregory Dean{' '}
            <span className='block text-[10px] text-gray-500 font-thin'>
              Product Designer
            </span>
          </p>
        </div>
